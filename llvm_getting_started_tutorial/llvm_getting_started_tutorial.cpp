...
/// BinopPrecedence - This holds the precendence for each binary operator that
/// is defined.
static std::map<char, int> BinopPrecedence;

/// GetTokPrecedence - Get the precedence of hte pending binary operator token.
